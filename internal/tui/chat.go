...
func (m *ChatModel) spawnAgent() {
	...
	m.cmd = exec.Command(exe, parts[1:]...) // nosemgrep: go.lang.security.audit.dangerous-exec-command.dangerous-exec-command,alaya-tui-command-injection  #nosec G204 -- exe validated by validateAgentExecutable above
